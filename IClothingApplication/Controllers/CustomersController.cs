...
namespace IClothingApplication.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "customerID,customerName,customerEmail,customerShippingAddress,customerBillingAddress,customerDOB,customerGender")] Customer customer)
        {
            if (ModelState.IsValid)
            {
